...
<div class="container-fluid pt-1">
    <div class="row px-xl-5">
        <div class="col-lg-6 offset-lg-3">
            <form action="authentication" class="d-flex flex-column text-center mb-4 mt-4 p-2" method="post" style="border-radius:25px;box-shadow: 1px 1px 10px 5px #e8f0fe;z-index: 1;flex-wrap: wrap;">
                <div class="d-flex flex-row" style="justify-content: space-between;flex-wrap: wrap;align-items: center;">
                    <label for="username" style="color:#666666">Username</label>
                    <input class="form-control" type="text" id="username" name="username" placeholder="username" required="" style="
    width: 80%;
">
                </div>
                <div class="d-flex flex-row" style="justify-content: space-between;margin-top: 10px;flex-wrap: wrap;align-items: center;">
                    <label for="password" style="color:#666666">Password</label>
                    <input class="form-control" type="password" id="password" name="password" placeholder="password" required="" style="
    width: 80%;
">
                </div>
                <div class="d-flex flex-column" style="align-items: center;">
                    <button class="btn  btn-primary font-weight-bold my-3 py-1" type="submit" style="
    width: 35%;
">Login</button>
                </div>
            </form>
